<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="图片/封面图链接" prop="imageUrl" width="120" />
        <el-table-column align="left" label="素材类型" prop="type" width="120" />
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="视频链接:"  prop="videoUrl" >
              <el-input v-model="formData.videoUrl" :clearable="true"  placeholder="请输入视频链接" />
            </el-form-item>
            <el-form-item label="图片/封面图链接:"  prop="imageUrl" >
              <el-input v-model="formData.imageUrl" :clearable="true"  placeholder="请输入图片/封面图链接" />
            </el-form-item>
            <el-form-item label="素材类型:"  prop="type" >
              <el-input v-model.number="formData.type" :clearable="true" placeholder="请输入素材类型" />
            </el-form-item>
            <el-form-item label="格式:"  prop="format" >
              <el-input v-model="formData.format" :clearable="true"  placeholder="请输入格式" />
            </el-form-item>
    ...
    <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                ...
                <el-descriptions-item label="图片/封面图链接">
                        {{ formData.imageUrl }}
                </el-descriptions-item>
