  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" :style="{ width: '185px' }" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="视频格式" prop="format">
         <el-input v-model="searchInfo.format" placeholder="视频格式" :style="{ width: '80px' }" />
        </el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="操作" min-width="120">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateVideoFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="120px">
            ...
            <el-form-item label="封面图链接:"  prop="image_url" >
              <el-input v-model="formData.image_url" :clearable="true"  placeholder="请输入封面图链接" />
            </el-form-item>
            <el-form-item label="视频格式:"  prop="format" >
...
const getTableData = async() => {
  const table = await getVideoList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
// 更新行
const updateVideoFunc = async(row) => {
...
// 删除行
const deleteVideoFunc = async (row) => {
