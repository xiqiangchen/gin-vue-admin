...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		example.ExaFileUploadAndDownload{}, resource.Video{}, resource.Image{}, assert.Target{}, ad.Plan{}, assert.Policy{}, resource.Material{}, ad.Campaign{}, assert.BlackWhiteList{}, ad.Creative{},
	)
	if err != nil {
