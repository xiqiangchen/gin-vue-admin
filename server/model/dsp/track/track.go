...
type track struct {
	...
	RequestId   string `json:"rid,omitempty" form:"rid,omitempty"`   // 请求id
...
func (imp *Impression) Marshal() []byte {
	byt, _ := json.Marshal(imp)
	return byt
}
...
func (clk *Click) Marshal() []byte {
	byt, _ := json.Marshal(clk)
	return byt
}
