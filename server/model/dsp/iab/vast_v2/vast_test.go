...
func TestVAST_CDataWrapper(t *testing.T) {
	v := VAST{
		Version: "3.0",
		Ads: []Ad{
			{
				...
				InLine: &InLine{
					AdSystem:    &AdSystem{Name: "DSP"},
					AdTitle:     CDATAString{CDATA: "懒得出门，点份美味外卖慰劳自己！"},
					Description: &CDATAString{CDATA: "美团外卖，送啥都快!"},
					Impressions: []Impression{
						{ID: "11111", URI: "http://impressionv1.track.com"},
						{ID: "11112", URI: "http://impressionv2.track.com"},
					},
					Creatives: []Creative{
						{
							...
							Linear: &Linear{
								...
								VideoClicks: &VideoClicks{
									ClickThroughs:  []VideoClick{{URI: "https://www.baidu.com"}},
									ClickTrackings: []VideoClick{{URI: "https://ct.bidex.cn/bidex/click/r.gif?slt=7&rid=e47d9e00792d6ee625fd5114ae893d97"}},
								},
								MediaFiles: []MediaFile{
									{
										Delivery: "progressive",
							...
							CompanionAds: &CompanionAds{
								...
								Companions: []Companion{{
									...
									Width:          720,
									Height:         1280,
									StaticResource: &StaticResource{CreativeType: "image/jpg", URI: "https://p0.meituan.net/waimaiad/8327cab6f4f18ba20bc8d597f07cf739841883.jpg"},
								}}},
						},
					},
				},
